/** Seed content — Who Was Abraham in the Bible */
export const abrahamArticle = {
  slug: "who-was-abraham-in-the-bible",
  title:
    "Who Was Abraham in the Bible? Faith, Covenant, and God's Promise to the Nations",
  excerpt:
  ...
  featuredImg: "/images/articles/who-was-abraham-in-the-bible/hero.svg",
  tags: ["Abraham", "Genesis", "Covenant", "Faith", "Patriarchs", "Old Testament"],
  body: `## Introduction
...
![Abraham's journey of faith — illustration](/images/articles/who-was-abraham-in-the-bible/hero.svg)
...
1. R. E. Clements, "Abraham," in *Theological Dictionary of the Old Testament*, ed. G. Johannes Botterweck and Helmer Ringgren, trans. John T. Willis, vol. 1 (Grand Rapids: Eerdmans, 1974; repr., 1997), 52–58.

2. P. R. Williamson, "Abraham," in *Dictionary of the Old Testament: Pentateuch*, ed. T. Desmond Alexander and David W. Baker (Downers Grove, IL: InterVarsity Press, 2003), 8–17.`,
};
